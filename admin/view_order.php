         ...
         <div class="container row">
            <div class="col">
               <h4>
                  <b
                     >ORDER ID:
                     <?php echo $row['order_id']; ?></b
                  ><br />
                  <b
                     >METHOD:
                     <?php echo $row['method']; ?></b
                  ><br /><br />
                  <b
                     >ORDER STATUS:
                     <?php if($row['status'] == 'success') {echo 'ITEM RECEIVED';} else { echo $row['status'];} ?></b
                  >
               </h4>
               ...
               <h4>
                  Address:
                  <?php echo $row['house']. ", ".$row['street']. ", ".$row['barangay']. ", ".$row['city'] ?>
               </h4>
            ...
            <div class="col">
              <label for="">VALID ID:</label><br>
               <img src="../<?php echo $row['identity']; ?>" alt="ID" class="identity" />
            </div>
